...
export const toggleZaboLike = createAction(
  TOGGLE_ZABO_LIKE,
...
export const getSearchZaboList = createAction(
  GET_SEARCH_ZABO_LIST,
  ZaboAPI.getSearchZaboList,
  (meta) => meta,
);
...
export default handleActions(
  {
    ...
    ...pender({
      ...
      onSuccess: (state, action) =>
        produce(state, zaboListProducer(action.payload, "hot", false, true)),
    }),
    ...pender({
      type: GET_ZABO_LIST,
      onSuccess: (state, action) => {
