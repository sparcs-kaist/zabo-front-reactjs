...
export const pinZabo = (zaboId) =>
  axios.post('/zabo/pin', { zaboId }).then(res => res.data)
export const unpinZabo = (zaboId) =>
  axios.delete('/zabo/pin', { data: { zaboId } }).then(res => res.data)
